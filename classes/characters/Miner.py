...
class Miner(Characters):
    ...
    def __init__(self, pseudo: str, pos_to_mine: V2=V2(2,0), pos_to_craft: V2=V2(-2,-3)):
        ...
        self.item_minning = 'copper_ore'
        self.item_crafting = 'copper_bar'
    ...
    def getActionPackage(self) -> str|tuple[str,dict]:
        ...
        match self.status:
            ...
            case 'mining':  # mining.
                ...
                if self.pos == self.pos_to_mine:
                    return str(Actions.Gather)
                
                return (str(Actions.Move), { 'pos': self.pos_to_mine})
